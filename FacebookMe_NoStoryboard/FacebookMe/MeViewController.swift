...
class MeViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        //네비게이션바 배경색 설정
        self.navigationController?.navigationBar.barTintColor = UIColor(red: 66.0/255, green: 103.0/255, blue: 178.0/255, alpha: 1.0)
        self.navigationController?.navigationBar.isTranslucent = false
        
        //네비게이션바 타이틀 내용 및 타이틀 색상 설정
    ...
    func attribute() {
        ...
        table.register(GeneralCell.self,forCellReuseIdentifier: "generalCell")
        table.register(AddCell.self,forCellReuseIdentifier: "addCell")
        table.register(LogOutCell.self,forCellReuseIdentifier: "logOutCell")
    }
    func layout() {
